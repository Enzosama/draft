          ...
          <div className="lg:col-span-1 space-y-3 overflow-y-auto pr-2">
            ...
            <div className="border border-gray-200 rounded-lg p-3">
              ...
              <div
                ...
                className={`relative border-2 border-dashed rounded-lg p-5 mb-3 cursor-pointer transition-all duration-200 ${
                  isDragging
            ...
            <div className="border-t border-gray-200 pt-2 flex-shrink-0">
              <div className="mb-2">
                ...
                <div className="flex gap-2">
                  <button
                    type="button"
                    onClick={() => setSystemPrompt('Hướng dẫn giải bài tập')}
                    className={`flex-1 px-3 py-2 rounded-lg text-sm font-medium transition-all duration-200 ${
                      systemPrompt === 'Hướng dẫn giải bài tập'
                  ...
                  <button
                    type="button"
                    onClick={() => setSystemPrompt('Trả lời dựa trên tài liệu')}
                    className={`flex-1 px-3 py-2 rounded-lg text-sm font-medium transition-all duration-200 ${
                      systemPrompt === 'Trả lời dựa trên tài liệu'
                        ? 'bg-blue-600 text-white shadow-md'
                        : 'bg-gray-100 text-gray-700 hover:bg-gray-200 border border-gray-300'
                    }`}
                  >
